...
cmd = "%s/reviewd/%s/%s/*%s*/ncounts.err"%(agent_log,options.config,options.version,options.pattern)
print("\n Pattern: %s\n"%cmd)
os.system("ls %s"%cmd)
if options.exec:
    os.system("rm %s"%cmd)

cmd = "%s/reviewd/%s/%s/*%s*/ncounts.err"%(agent_www,options.config,options.version,options.pattern)
print("\n Pattern: %s\n"%cmd)
os.system("ls %s"%cmd)
if options.exec:
    os.system("rm %s"%cmd)
